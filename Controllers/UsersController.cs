...
namespace WebApi.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        private ICurrencyConvertionService _converter;
        ...
        public UsersController(
            ...
            ICurrencyConvertionService converter)
        {
        ...
        public IActionResult ChangePassword([FromForm]UserDto userDto, string newPassword)
        {
            if (string.IsNullOrEmpty(userDto.Password))
                return Ok("Old password should be entered");
            var res = _userService.ChangePassword(userDto, newPassword);
            if (res.Any())
                return Ok(res);
        ...
        public IActionResult ConvertNairaToDollar([FromBody]CurrencyConverterDTO model)
        {
            ...
            return Ok(res.newAmount);
        }

        [HttpPost("PostRate")]
        [AllowAnonymous]
        public IActionResult PostRate([FromBody]Rate rate)
        {
            var res = _converter.AddRate(rate);
